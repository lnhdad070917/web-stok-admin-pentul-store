...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <ul id="rdp-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="tables-sold-rdp.php" class = "active">
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">DATA RDP SUDAH JUAL</h5>
              ...
              <table class="table datatable">
                ...
                <?php
                  include 'koneksi.php';
                  $query = mysqli_query($koneksi, "SELECT * from rdp Where status LIKE 's%'");
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href = "forms-rdp-edit-sold.php?nomor=<?php echo $data['nomor']; ?>" class="btn btn-warning rounded-pill">edit</a>
                      <a href = "action/delete-rdp-sold.php?nomor=<?php echo $data['nomor']; ?>" class = "btn btn-secondary rounded-pill" onclick=" confirm('Hapus data ini?')">Hapus</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
