          ...
          <div class="card">
            <div class="card-body">
              ...
              ?>
                ...
                <p>Provider : <?php echo $hasil['provider']; ?> </p>
                <p>Gmail    : ||<?php echo $hasil['email']; ?>|| </p>
                <p>PASS     : ||<?php echo $hasil['pass1']; ?>|| </p>
                <p>PASS     : ||<?php echo $hasil['pass2']; ?>|| </p>
                <p>note     : </p>
                <p>1. Hapus cache dan cookie di browser anda sebelum login</p>
                <p>2. Pastikan ip yang digunakan fresh, dan usahakan ip indonesia</p>
                <p>3. Tidak bisa login ke akun akan kami ganti baru</p>
                <p>4. Jika ada perubahan akun (pass/upgrade) garansi hangus</p>
                <p>5. Jika saldo tidak sesuai akan kami ganti baru</p>
                <p>6. Garansi berlaku untuk login pertama kali, dan pembuatan RDP/VPS Pertama Kali</p>
                <p>7. Garansi berupa penggantian akun baru</p>
                <?php } ?>
              </div>
