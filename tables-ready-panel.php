    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="panel-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-ready-panel.php" class="active">
              <i class="bi bi-circle"></i><span>Ready</span>
            </a>
          </li>
          <li>
            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php
                  include 'koneksi.php';
                  $query = mysqli_query($koneksi, "SELECT * from panel Where rs LIKE 'r%'");
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="forms-panel-edit-ready.php?nomor=<?php echo $data['nomor']; ?>" class="btn btn-warning rounded-pill">edit</a>
                        <a href="action/sold-panel.php?nomor=<?php echo $data['nomor']; ?>" class="btn btn-danger rounded-pill">Jual</a>
                        <a href="action/delete-panel-ready.php?nomor=<?php echo $data['nomor']; ?>" class="btn btn-secondary rounded-pill" onclick=" confirm('Hapus data ini?')">Hapus</a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
