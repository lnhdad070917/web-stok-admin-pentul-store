...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
      <li>
        <a href="forms-rdp.php" class = "active">
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action = "action/upload-rdp.php">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input id = "cip" type="text" name = "ip" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select id = "cspec" class="form-select" name = "spec" aria-label="Default select example">
                      <option selected>Pilih Spesifikasi</option>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="form-check">
                      <input id = "cpass1" name ="pass1" class="form-check-input" type="checkbox" value = "PentulStore//">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id = "cpass2" name = "pass2" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="cdate" class="col-sm-2 col-form-label">Date</label>
                  <div class="col-sm-10">
                    <input type="date" id = "cdate" name = "date" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" id="cstatus" name = "status" aria-label="Default select example">
                      <option selected>Ready/Sold</option>
