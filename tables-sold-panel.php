          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <?php
                  include 'koneksi.php';
                  $query = mysqli_query($koneksi, "SELECT * from panel Where rs LIKE 's%'");
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href = "forms-panel-edit-sold.php?nomor=<?php echo $data['nomor']; ?>" class="btn btn-warning rounded-pill">edit</a>
                      <a href = "action/delete-panel-sold.php?nomor=<?php echo $data['nomor']; ?>" class = "btn btn-secondary rounded-pill" onclick=" confirm('Hapus data ini?')">Hapus</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
